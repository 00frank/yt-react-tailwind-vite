...
export function UnauthenticatedUserIcon({ className = "", fill = "#3ea6ff", size = "24" }) {
  return (
    <svg className={className} fill={fill} xmlns="http://www.w3.org/2000/svg" height={size} viewBox="0 0 24 24" width={size} focusable="false">
